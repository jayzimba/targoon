...
const Home = ({ navigation }) => {
    ...
    const renderItem = ({ item }) => ( < Item onClicked = {
    ...
    return ( <
        ...
        onPress = {
            () => navigation.navigate("Cart", { clickedItems }) } > {
            cartCounter >= 1 ? ( <
                View style = {
                    {
        ...
        <
        Text style = {
            { fontSize: 22, fontWeight: "800", marginBottom: 30 } } >
        Categories < />Text>
        ...
        <
        Ionicons name = "phone-portrait-outline"
        size = { 30 }
        color = "black" / >
        <
        />View> <
        ...
        View style = { styles.category } >
        <
        Ionicons name = "md-headset-sharp"
        size = { 30 }
        color = "black" / >
        <
        />View> <
        ...
        <
        Text style = {
            { fontSize: 22, fontWeight: "800", marginVertical: 30 } } >
        Latest < />Text>
        ...
        style = {
            { marginBottom: 30 } } >
        <
        ImageBackground source = { require("../assets/images/var.jpg") }
        imageStyle = {
            { borderRadius: 10 } }
        style = { styles.card } >
        <
        ...
        <
        Text style = {
            { color: "#000", fontSize: 16 } } > Order Now < />Text> < / >
        TouchableOpacity > < />ImageBackground> <
        ImageBackground source = { require("../assets/images/pixel.jpg") }
        imageStyle = {
            { borderRadius: 10 } }
        style = { styles.card } >
        <
        ...
        Text style = {
            { color: "#000", fontSize: 16 } } > Order Now < />Text> < / >
        TouchableOpacity > < />ImageBackground> <
        ImageBackground source = { require("../assets/images/mac.jpg") }
        imageStyle = {
            { borderRadius: 10 } }
        style = { styles.card } >
        <
...
const styles = StyleSheet.create({ container }: { paddingHorizontal }: 15,
